...
create_kernel -type c hestonEuroBarrier
...
create_compute_unit -opencl_binary [get_opencl_binary heston] -kernel [get_kernels hestonEuroBarrier] -name K1
...
run_emulation -flow hardware -args "-a heston.xclbin -n hestonEuroBarrier -p 0.887 -c 0.776 -s 4"
